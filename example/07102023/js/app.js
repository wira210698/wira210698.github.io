...
const data =()=>{
    let link_gmaps = 'https://google.com',
        tanggal = '2023-10-21',
        tanggal_kata = 'Sabtu, 21 Oktober 2023',
        waktu = '10:00:00',
        waktu_kata = '10.00 Wita',
        foto = [
            'assets/images/galeri/1.jpg',
            'assets/images/galeri/2.jpg',
            'assets/images/galeri/3.jpg',
            'assets/images/galeri/4.jpg',
            'assets/images/galeri/5.jpeg',
            'assets/images/galeri/6.jpeg',
        ],
        foto_home = 'assets/images/bg.jpeg',
        nama_panggilan = 'Komang Tengah & Luh Yudani',
        nama_cewe = 'Ni Luh Yudani',
        nama_cewe_ortu_cewe = 'Ni Ketut Aryamini',
        nama_cewe_ortu_cowo = 'I Komang Gede',
        nama_cowo = 'I Komang Tengah',
        nama_cowo_ortu_cewe = 'Ni Ketut Lali',
        nama_cowo_ortu_cowo = 'I Wayan Sari',
        nama_acara = 'Upacara Manusa Yadnya',
        nama_detail_acara = 'Pawiwahan / Pernikahan',
        alamat ="Banjar dinas Tanah Ampo, Ds. Jungutan, Kabupaten Karangasem";

        $('.nama_acara').html(nama_acara);
        $('.nama_detail_acara').html(nama_detail_acara);
        $('.nama_panggilan').html(nama_panggilan);
        $('.tanggal_kata').html(tanggal_kata);
        $('.waktu_kata').html(waktu_kata);
        $('.alamat').html(alamat);
        // $('#tampilan-waktu').data(alamat);
}
