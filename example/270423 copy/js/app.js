...
const data =()=>{
    let link_gmaps = 'https://google.com',
        ...
        nama_panggilan = 'Putu Indah & Kadek Ary',
        nama_cewe = 'Putu Indah Purnami Dewi',
        nama_cewe_ortu_cewe = 'Gst Kadek Ayu Ratna Erawati',
        nama_cewe_ortu_cowo = 'I Komang Arimbawa',
        nama_cowo = 'Kadek Ary Surya Darma',
        nama_cowo_ortu_cewe = 'Gst Kadek Ayu Ratna Erawati',
        nama_cowo_ortu_cowo = 'I Komang Arimbawa',
        nama_acara = 'Upacara Manusa Yadnya',
        nama_detail_acara = 'Mepandes / Potong Gigi';
